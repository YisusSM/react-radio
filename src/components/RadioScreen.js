...
import background7 from '../assets/7.png';
import background8 from '../assets/8.png';
...
const RadioScreen = () => {
    ...
    const image = useMemo(() => [background0, background1, background2, background3, background4, background5, background6,background7,background8], []);
